...
var dataLength = _data2.default.tracks.length;
var timeScale = canvas.height / _data2.default.duration;
var minNote = 25;
var maxNote = 90;
var dif = canvas.width / (maxNote - minNote);
for (var i = 0; i < dataLength; i++) {
  var d = _data2.default.tracks[i].notes;
  console.log(_data2.default.tracks[i]);
